...
Route::middleware(['auth', 'approved'])->group(function () {
  Route::livewire('/home', 'page-home')
    ->name('page-home');
  Route::livewire('/checks', 'page-checks')
    ->name('page-checks');
Route::livewire('/applications', 'page-applications')
    ->name('page-applications');

Route::livewire('/applications/weekend', 'forms.page-weekend')
    ->name('page-applications.weekend');
