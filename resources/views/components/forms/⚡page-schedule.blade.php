...
new class extends Component {
    ...
    public function submit(StaffFormTelegramService $telegram): void
    {
        ...
        try {
            ...
            $this->successMessage = 'Ваш вопрос по графику отправлен.';
...
@push('meta')
<title>Вопрос по графику • Tris Service Academy</title>
                ...
                <div class="p-[20px]">
                    <div class="mb-[24px]">
                        ...
                        <p class="text-[15px] leading-[1.5] text-black/55">
                            Выберите тип вопроса и опишите, что нужно изменить или уточнить.
                        </p>
                    </div>
                    ...
                    <div class="space-y-[18px]">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="6"
                                maxlength="2000"
                                placeholder="Например: не смогу выйти в воскресенье вечером, нужен перенос"
                            ...
                            <div class="mt-[8px] flex items-center justify-between gap-[12px] px-[4px]">
                                ...
                                @else
                                    <div class="text-[13px] text-[#6F8096]">
                                        Можно указать дату, смену или короткую причину.
                                    </div>
                                @enderror
