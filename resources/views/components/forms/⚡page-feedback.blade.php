...
public function resetForm(): void
{
    ...
    $this->dispatch('feedback-suggestion-clear-draft');
}
...
<div
    x-data="{
        ...
        storageKey: 'feedback-suggestion-draft',
    ...
    x-on:feedback-suggestion-clear-draft.window="clearDraft()"
                ...
                <div class="p-[20px] pb-[82px]">
                    ...
                    <div class="mb-[18px]">
                        ...
                        <x-ui.textarea
                            ...
                            rows="6"
                            maxlength="2000"
                            placeholder="Например: было бы удобно, если бы в приложении появилась новая функция"
                        />
    ...
    <label class="block cursor-pointer rounded-[23px] border border-[#E7E7E7] bg-[#F8F8F8] px-[18px] py-[14px] transition duration-200 hover:bg-white">
        ...
        <div class="flex items-center justify-between">
            ...
            <x-heroicon-o-arrow-up-tray
                class="h-[18px] w-[18px] text-[#213259]"
            />
        </div>
        ...
        @if (! empty($attachments))
            <div class="mt-[14px] flex gap-[10px] overflow-x-auto pb-[2px] no-scrollbar">
                @foreach ($attachments as $index => $file)
                    <div
                        class="relative h-[132px] w-[112px] shrink-0 overflow-hidden rounded-[16px] border border-[#E7E7E7] bg-white"
                    >
...
>
    ...
    <x-ui.guide
        guide-key="feedback-suggestion-guide-v1"
        :steps="[
            ['title' => 'Обратная связь', 'text' => 'Выберите тему, опишите предложение или проблему и при необходимости приложите файл.'],
            ['title' => 'Опишите подробнее', 'text' => 'Добавьте конкретные детали: где возникла проблема, что уже проверили и какого результата ожидаете.'],
            ['title' => 'Отправьте обращение', 'text' => 'Проверьте текст и нажмите «Отправить». После отправки обращение попадёт ответственному сотруднику.'],
        ]"
    />
</div>
