            ...
            ->recordActions([
                ActionGroup::make([
                    Action::make('approve')
                        ...
                        ->visible(fn(DayOffRequest $record) => $record->status !== 'approved')
                        ->action(fn(DayOffRequest $record) => $record->update([
                            'status' => 'approved',
                        ])),
                    ...
                    Action::make('reject')
                        ...
                        ->color('danger')
                        ->requiresConfirmation()
                        ->visible(fn(DayOffRequest $record) => $record->status !== 'rejected')
                        ->action(fn(DayOffRequest $record) => $record->update([
                            'status' => 'rejected',
                        ])),
